            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                <div class="text-center">
                  ...
                  src="{{asset('assets/images/projects')}}/{{$image}}"
                       alt="project image">
                </div>
                ...
                <a href="{{route('backend.projects.edit',['id_project'=>$id_project])}}" class="btn btn-warning btn-block"><b>Modifier</b></a>
                <a href="#" onclick="confirm('Voulez Vous vraiment supprimer cet project ?')|| event.stopImmediatePropagation()" 
                wire:click.prevent="deleteProject({{$id_project}})" class="btn btn-danger btn-block"><b>Supprimer</b></a>
